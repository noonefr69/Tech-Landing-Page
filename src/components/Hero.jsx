...
export default function Hero() {
  return (
    <div id="back" className="px-4 pt-7">
      <div className="sm:px-10 sm:max-w-[768px] sm:mx-auto">
        <nav className="pb-10">
          <Nav />
        </nav>
        <h1 className="md:text-7xl md:max-w-[80%] pb-8 text-5xl font-bold bg-gradient-to-r from-[#d48050] to-[#062630] bg-clip-text text-transparent">
